...
describe Order do
  let(:order) { Order.new(email: "hello@aol.com", address: "123 Main Street Seattle, WA 98101", name: "Lionel Ritchie", cc_num: "1234567890123456", cc_expiry: "10/19", cc_cvv: "123", billing_zip: "98101", order_products: [order_products(:one), order_products(:two)]) }

  describe "validations" do
    it "must have an address" do
      order.address = nil
      order.valid?.must_equal false
      order.address = "123 Main Street Seattle, WA 98101"
